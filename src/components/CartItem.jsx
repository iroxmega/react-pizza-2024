...
function CartItem({id, title, price, imageUrl, typeProp, pizzaSize, count}) {
    ...
    const onClickMinus = () => {
        dispatch(decrement({id, typeProp, pizzaSize}))
    }
    const onClickRemove = () => {
        dispatch(removeItem({id, typeProp, pizzaSize}))
    }
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-info">
                <h3>{title}</h3>
                <p>{typeProp} тесто, {pizzaSize} см.</p>
            </div>
            <div className="cart__item-count">
                <div onClick={count === 1? onClickRemove : onClickMinus} className="button button--outline button--circle cart__item-count-minus">
